...
emotional manipulation, and contextual loopholes, making traditional
rule-based security systems ineffective.

## 💡 Solution Overview
This project proposes an AI-powered real-time cybersecurity system that
detects and prevents emerging scams by analyzing behavioral signals,
emotional manipulation, and contextual anomalies across digital
communications.
...
- AI: NLP-based behavioral & emotion analysis
...
![Saenix AI UI](./screenshot.png) *(Note: Add a screenshot of your dashboard here before submitting!)*

## 🛑 The Problem
Traditional cybersecurity focuses on technical payloads (malware signatures, blacklisted IPs). However, modern threat actors bypass these filters using **Social Engineering**—manipulating human psychology through fear, urgency, and false authority. 
